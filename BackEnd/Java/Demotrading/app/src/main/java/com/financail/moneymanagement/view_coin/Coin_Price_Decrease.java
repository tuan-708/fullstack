...
public class Coin_Price_Decrease extends Fragment {
    private ProgressBar e_progressBar;

    public Coin_Price_Decrease() {
        // Required empty public constructor
    }


    public static Coin_Price_Decrease newInstance(String param1, String param2) {
        Coin_Price_Decrease fragment = new Coin_Price_Decrease();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                Collections.sort(coinList, new SortByPriceDecrease());
